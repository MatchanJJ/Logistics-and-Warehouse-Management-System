...
async function getEmployeeLogs () {
    try {
        const [result] = await db.query('SELECT * FROM employee_logs');
        return result;
    } catch (error) {
...
async function getOrderLogs () {
    try {
        const [result] = await db.query('SELECT * FROM order_logs');
        return result;
    } catch (error) {
...
async function getParcelInventoryLogs () { 
    try {
        const [result] = await db.query('SELECT * FROM parcel_inventory_logs');
        return result;
    } catch (error) {
...
async function getProductInventoryLogs () {
    try {
        const [result] = await db.query('SELECT * FROM product_inventory_logs');
...
async function getReturnLogs () {
    try {
        const [result] = await db.query('SELECT * FROM return_logs');
        return result;
    } catch (error) {
...
async function getShipmentLogs () {
    try {
        const [result] = await db.query('SELECT * FROM shipment_logs');
        return result;
    } catch (error) {
...
async function getWarehouseLogs () {
    try {
        const [result] = await db.query('SELECT * FROM warehouse_logs');
        return result;
    } catch (error) {
...
async function getCustomerLogs () {
    try {
        const [result] = await db.query('SELECT * FROM customer_logs');
        return result;
    } catch (error) {
        console.error('Error getting warehouse_logs: ', error);
    }
